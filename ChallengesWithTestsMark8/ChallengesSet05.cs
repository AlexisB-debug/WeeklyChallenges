    ...
    public class ChallengesSet05
    {
        ...
        public int SumElementsThatFollowAnEven(int[] numbers)
        {
            try
            {
                ...
                List<int> nextTwoAfterFirstEven = new List<int>();

                foreach (int number in numbers)
                {
                    if (foundFirstEven == false)
                    {
                        if (number % 2 == 0)
                        {
                            foundFirstEven = true;
                    ...
                    {
                        // sum = sum + number;
                        if (nextTwoAfterFirstEven.Count < 2)
                        {
                            nextTwoAfterFirstEven.Add(number);
                        }
                    }
                }

                // return sum;
                int sum = nextTwoAfterFirstEven.Sum();
                return sum;
            }
